							...
							<div className="row">
								...
								<div className="col-6 col-md-4 col-xl-2" key={index}>
										<div className="package-card">
												<input type="radio" className="btn-check" name="options-plan" id={`options-plan-${index+1}`} value={packages.packageId} onChange={onPackageChange} autoComplete="off" disabled={packages.amount === 0 ? true : false}/>
