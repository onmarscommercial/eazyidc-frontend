                ...
                <div className="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                  <div className="card-no-top-border">
                    <div className="card-body">
                      <h5 className="card-title">{t('PersonalInformation')}</h5>
                      <div className="row">
                        <p className="col-5 text-end text-secondary mb-2">{t('Email')}</p>
                        <p className="col col-xl-7 mb-2">{email}</p>
                      </div>
                      <div className="row">
                        <p className="col-5 text-end text-secondary mb-2">{t('Password')}</p>
